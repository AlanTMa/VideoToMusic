            ...
            <div className="flex items-center justify-between h-16">
              ...
              <nav className="hidden md:flex items-center space-x-1">
                ...
                <a
                  ...
                  className="flex items-center space-x-2 px-4 py-2 text-sm bg-gradient-to-r from-yellow-500 to-orange-500 text-white rounded-lg hover:shadow-lg hover:scale-105 transition-all"
                >
                  <span>☕</span>
                    ...
                    className={`
                      ...
                      ${isActive
                        ...
                        : isAccessible
                          ...
                          : 'text-gray-600 cursor-not-allowed opacity-70 bg-gray-50'
                      }
                    `}
                  >
